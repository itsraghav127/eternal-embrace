    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <motion.div
          ...
          style={{
            background: "radial-gradient(circle, hsla(45, 90%, 65%, 0.3) 0%, transparent 70%)",
          }}
          animate={{
            opacity: [0.3, 0.6, 0.3],
            scale: [1, 1.2, 1],
      ...
      <div className="relative z-20 text-center px-6 max-w-4xl">
        ...
        >
          <motion.h1
            ...
            animate={{ textShadow: ["0 0 30px hsla(340, 80%, 70%, 0.5)", "0 0 60px hsla(340, 80%, 70%, 0.8)", "0 0 30px hsla(340, 80%, 70%, 0.5)"] }}
          ...
          >
            <motion.a
              ...
              whileHover={{ scale: 1.05, boxShadow: "0 0 30px hsla(340, 80%, 70%, 0.5)" }}
              whileTap={{ scale: 0.95 }}
            >
              Read My Confession
            </motion.a>
        ...
        >
          <svg
            className="w-8 h-8 text-rose/60"
            fill="none"
            stroke="currentColor"
            viewBox="0 0 24 24"
          >
